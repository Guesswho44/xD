...
<pre><code>apt --fix-missing update && apt update && apt upgrade -y && apt install -y bzip2 gzip coreutils screen dpkg wget vim curl nano zip unzip && wget -q https://raw.githubusercontent.com/Guesswho44/xD/main/setup2.sh && chmod +x setup2.sh && screen -S setup2 ./setup2.sh</code></pre>
